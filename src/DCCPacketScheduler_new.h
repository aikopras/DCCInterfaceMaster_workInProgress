...
class DCCPacketScheduler
{
  public:
	...
	void setLocoFuncBinary(uint16_t address, uint8_t low, uint8_t high);	//Bin�rzustandsadressen von 29 bis 32767
	...
	byte getFunktion29to31(uint16_t address);	//gibt Funktionszustand F31 - F29 zur�ck
